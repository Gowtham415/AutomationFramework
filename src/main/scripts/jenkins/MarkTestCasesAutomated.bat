...
REM This script was created to run MarkCasesAutomated tool, it was designed to work with any Textura application.
REM Script takes the name of the Application as a paramater
...
SET TOOL_NAME="com.textura.%APPLICATION_NAME_LOWER_CASE%.tools.%APPLICATION_NAME%MarkCasesAutomated"

TITLE Run MarkAllCasesAutomated script for %APPLICATION_NAME%
