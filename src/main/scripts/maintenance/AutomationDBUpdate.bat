...
REM This script was created to run AutomationDBUpdate tool, it was designed to work with any Textura application.
REM Script takes the name of the Application as a parameter
...
SET TOOL_NAME="com.textura.%APPLICATION_NAME_LOWER_CASE%.database.AutoDBStatsPopulate%APPLICATION_NAME%"

TITLE Run AutoDBStatsPopulate script for %APPLICATION_NAME%
